<script lang="ts">
	...
	import NavigationItem from '$components/navigation/navigation-item.svelte';
	...
	<div class="header--inner">
		<div class="wrapper">
			<nav class="primary-navigation">
				...
				<ul class="nav-socials | flex-group" role="list">
					<li>
						<a href="mailto:j.vdv@outlook.com" class="flex-group">
							<Mail />
						</a>
					</li>
					<li>
						<a href="https://github.com/JonaVDV">
							<svg role="img" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"
								><title>GitHub Profile</title><path
									fill="currentColor"
